...
namespace engine::core {
    Context::Context(Config& config, input::InputManager& inputManager, resource::ResourceManager& resourceManager, SDL_Window* window, raii::SDL_TrayType& trayType, SDL_Renderer* renderer, bool& runningState, std::atomic<SDL_AppResult>& appResult)
